...
def test_pages_promise_only_what_they_give(page):
    ...
    # перечисление ушло из лида: масштаб теперь показывают счётчики в меню разделов
    assert "231" in body and "22 аркана" in body, "масштаб справочника перестал быть виден"
