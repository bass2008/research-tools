      ...
      <div className="wrap">
        ...
        <div className="prose section-gap">
          ...
          <p>
            ...
            родовой опоры, энергия — от месяца и миссии, эмоции — сумма первых двух. Смещение по номеру
            уровня разводит строки: без него все семь были бы одинаковыми.
          </p>
          <p>
        ...
        <div className="panel section-gap">
          ...
          <div className="cap">Семь чакр от нижней к верхней</div>
