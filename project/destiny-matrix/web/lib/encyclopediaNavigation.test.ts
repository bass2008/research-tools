...
describe("единый реестр навигации энциклопедии", () => {
  ...
  // Единственный раздел без ветки: статьи — это адреса первого уровня. Ведём на якорь
  // оглавления, а не на `?sec=`: параметр создавал адрес, который Яндекс скачивал с каждой
  // страницы справочника и складывал в «неканонические».
  it("ведёт статьи на якорь оглавления, а не на адрес с параметром", () => {
    expect(encyclopediaSectionHref("art")).toBe("/encyclopedia#stati");
  });
