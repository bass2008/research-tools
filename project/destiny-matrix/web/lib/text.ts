...
export const forLocale = localized((L: Locale) => {
  ...
  function withRepeat(base: string, repeated: string | null): string {
  ...
  function cubeClause(cube: string): string {
  ...
  function pairCubes(left: string, right: string): [string, string] {
  ...
  return { clip, withRepeat, sentence, cubeClause, pairCubes };
});

// Compatibility for callers that explicitly use the deployment default.
export const { clip, withRepeat, sentence, cubeClause, pairCubes } = forLocale(defaultLocale);
