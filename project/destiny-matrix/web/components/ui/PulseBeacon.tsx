 ...
 * отдельный. Иначе пять открытых страниц выглядели в админке как пять разных людей. HttpOnly-куку
 * при наличии добавляет BFF: JavaScript по-прежнему не видит ни токен, ни user_id.
 */
