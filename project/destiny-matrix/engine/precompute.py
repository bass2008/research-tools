...
Матрица зависит не от даты, а от тройки (день, месяц, год) после свёртки, поэтому десятки тысяч
реальных дат рождения дают всего 5 544 различных матрицы: 22 x 12 x 21. Их можно
